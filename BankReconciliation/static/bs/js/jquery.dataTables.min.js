    ...
    $.fn.dataTable = function(oInit) {
        ...
        function _fnDraw(oSettings) {
            ...
            if (oSettings.aaData.length != 0) {
                for (var j = oSettings.iDisplayStart; j < oSettings.iDisplayEnd; j++) {
                    ...
                    if (oSettings.asStripClasses.length > 0) {
                        anRows[iRowCount].className = oSettings.asStripClasses[iRowCount % oSettings.asStripClasses.length]
                    }
                    ...
                    if (typeof oSettings.fnRowCallback == "function") {
                        anRows[iRowCount] = oSettings.fnRowCallback(anRows[iRowCount], oSettings.aaData[j], iRowCount, j)
                    }
                    iRowCount++
                }
            } else {
            ...
            if (typeof oSettings.fnHeaderCallback == "function") {
                oSettings.fnHeaderCallback($("thead tr", oSettings.nTable)[0], oSettings.aaData, oSettings.iDisplayStart, oSettings.iDisplayEnd)
            }
            if (typeof oSettings.fnFooterCallback == "function") {
                oSettings.fnFooterCallback(oSettings.nFooter, oSettings.aaData, oSettings.iDisplayStart, oSettings.iDisplayEnd)
            }
            ...
            if (oSettings.oFeatures.bInfo) {
                if (oSettings.aaData.length == 0 && oSettings.aaData.length == oSettings.aaDataMaster.length) {
                    oSettings.nInfo.innerHTML = oSettings.oLanguage.sInfoEmtpy + " " + oSettings.oLanguage.sInfoPostFix
                } else {
                    if (oSettings.aaData.length == 0) {
                        oSettings.nInfo.innerHTML = oSettings.oLanguage.sInfoEmtpy + " " + oSettings.oLanguage.sInfoFiltered.replace("_MAX_", oSettings.aaDataMaster.length) + " " + oSettings.oLanguage.sInfoPostFix
                    } else {
                        if (oSettings.aaData.length == oSettings.aaDataMaster.length) {
                            oSettings.nInfo.innerHTML = oSettings.oLanguage.sInfo.replace("_START_", oSettings.iDisplayStart + 1).replace("_END_", oSettings.iDisplayEnd).replace("_TOTAL_", oSettings.aaData.length) + " " + oSettings.oLanguage.sInfoPostFix
                        } else {
                            oSettings.nInfo.innerHTML = oSettings.oLanguage.sInfo.replace("_START_", oSettings.iDisplayStart + 1).replace("_END_", oSettings.iDisplayEnd).replace("_TOTAL_", oSettings.aaData.length) + " " + oSettings.oLanguage.sInfoFiltered.replace("_MAX_", oSettings.aaDataMaster.length) + " " + oSettings.oLanguage.sInfoPostFix
                        }
                    }
                }
            }
        ...
        function _fnFilter(oSettings, sInput, iForce) {
            ...
            if (sInput.length <= 0) {
                ...
                if (oSettings.aaData.length == oSettings.aaDataMaster.length || oSettings.sPreviousSearch.length > sInput.length || iForce == 1) {
        ...
        _fnSort = function(oSettings) {
            ...
            for (var i = 0; i < aaSort.length - 1; i++) {
                sDynamicSort += "iTest = oSort['" + oSettings.aoColumns[aaSort[i][0]].sType + "-" + aaSort[i][1] + "']( a[" + aaSort[i][0] + "], b[" + aaSort[i][0] + "] ); if ( iTest == 0 )"
            }
